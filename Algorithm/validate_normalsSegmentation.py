...
CONFIG = {
    ...
    "normal_feature_weight": 2.0, 

    "cluster_eps": 0.3,
    "cluster_min_points": 50,
    
    "vertical_axis_index": 2,
    "viz_floor_color_channel": 0,     # Red
    "viz_wall_color_channel": 2,      # Blue
    
    "viz_colormap_name": "tab20",
    "viz_noise_color": [0, 0, 0],     # Black
...
def validate_initial_setup(input_file, cfg):
    ...
    print("   Showing Normal Visualization...", flush=True)
    o3d.visualization.draw_geometries([pcd], window_name="AC1: Normal Visualization")

    print("3. Running Clustering...", flush=True)
    ...
    pcd_feat.points = o3d.utility.Vector3dVector(combined_features)
    
    labels = np.array(pcd_feat.cluster_dbscan(
        eps=cfg["cluster_eps"], 
...
if __name__ == "__main__":
    input_path = "C:/Users/dober/Downloads/emit-it_appartement_sor_noise_filtered-laz_2025-11-11_1332/appartement_SOR_NoiseFiltered_5mm.las" #My bad for this hardcode, change to your own local path where the las file is located
